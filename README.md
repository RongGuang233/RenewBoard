...
下图为 1.1.4 模拟器中的演示数据；首次安装默认为空账本。

<img src="docs/images/ledger-overview-v1.1.4.png" width="280" alt="账本统计概览"> <img src="docs/images/ledger-ranking-v1.1.4.png" width="280" alt="应用支出横向柱状图">
...
- 账本以统计概览为首页：月度实付、七档支出趋势（近1月/3月/6月/12月/自然年/5年/全部）、应用支出排行和付款明细。未补录的外币金额单独提示。
