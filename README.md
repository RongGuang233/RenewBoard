...
下图为 1.2.1 模拟器中的演示数据；首次安装默认为空账本。

<img src="docs/images/ledger-overview-v1.2.1.png" width="250" alt="含话费月费的支出统计"> <img src="docs/images/devices-list-v1.2.1.png" width="250" alt="默认服役中的紧凑设备列表"> <img src="docs/images/device-sold-detail-v1.2.1.png" width="250" alt="卖出日期与金额"> <img src="docs/images/settings-about-v1.2.1.png" width="250" alt="更新与作者信息">
